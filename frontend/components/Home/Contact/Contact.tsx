        ...
        items-center'>
            ...
            >
                <input
                  type='text'
                  placeholder='Name'
                  className='px-4 py-3.5 bg-gray-900 text-white outline-none rounded-md w-full
                  placeholder:text-white/70'
                  />
                  <input
                  type='email'
                  placeholder='Email Address'
                  className='px-4 py-3.5 mt-6 bg-gray-900 text-white outline-none rounded-md w-full
                  placeholder:text-white/70'
                  />
                  <input
                  type='text'
                  ...
                  <button className='mt-8 px-12 py-4 bg-blue-950 hover:bg-green-500 transition-all duration-300
